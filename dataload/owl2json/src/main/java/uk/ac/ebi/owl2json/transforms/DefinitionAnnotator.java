...
public class DefinitionAnnotator {
	...
	public static void annotateDefinitions(OwlGraph graph, Map<String,Object> ontologyConfig) {
		...
		Object configDefinitionProperties = ontologyConfig.get("definition_property");
